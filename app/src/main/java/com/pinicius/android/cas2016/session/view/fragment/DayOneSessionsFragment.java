...
import com.pinicius.android.cas2016.session.view.presenter.DayOneSessionsPresenter;
...
public class DayOneSessionsFragment extends BaseFragment implements DaySessionsPresenter.View {

    @Bind(R.id.rv_sessions) RecyclerView sessionsView;
    @Bind(R.id.loading) RotateLoading loadingView;

    @Inject @Presenter
    DayOneSessionsPresenter presenter;
