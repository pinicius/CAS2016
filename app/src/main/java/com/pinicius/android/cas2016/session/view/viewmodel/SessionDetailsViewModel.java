...
public class SessionDetailsViewModel {
    ...
    private final List<TagViewModel> tags;

    public SessionDetailsViewModel(int id, String name,
                                   String description, int duration,
                                   String startTime, String endTime,
                                   RoomSummaryViewModel room, List<SpeakerSummaryViewModel> speakers, List<TagViewModel> tags) {
        this.id = id;
        this.name = name;
