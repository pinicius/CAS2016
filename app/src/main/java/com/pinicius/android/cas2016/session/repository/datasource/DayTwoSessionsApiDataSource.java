...
public class DayTwoSessionsApiDataSource extends EmptyReadableDataSource<Integer, Session> {
    private static final String DAY_ONE_DATE = "2016-12-2";

    private final SessionApiClient sessionApiClient;
    private final SessionDtoToSessionMapper sessionDtoToSessionMapper;

    @Inject
    public DayTwoSessionsApiDataSource(SessionApiClient sessionApiClient, SessionDtoToSessionMapper sessionDtoToSessionMapper) {
